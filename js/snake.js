(function(){  
    ...
    var addpoison = function(){
        poison.x = Math.floor(Math.random() * ((canvas.width / 20) - 1));
        poison.y = Math.floor(Math.random() * ((canvas.height / 20) - 1));
        for(var i = 0; i < snake.length; i++){
            if(checkBlock(poison.x, poison.y, snake[i].x, snake[i].y)){
                addpoison();
            }
        }
    }
    ...
    var mainLoop = function(){
        ...
        // Eat poison
            ...
            if(checkBlock(snake[0].x, snake[0].y, poison.x, poison.y)){
                snake[snake.length] = {x: snake[0].x, y: snake[0].y};
                score -= 1;
                altScore(score);
                addpoison();
                activepoison(poison.x, poison.y);
            }
      ...
      // Eat Food
        ...
        // --------------------
            ...
            for(var i = 0; i > snake.length; i--){
                activePoison(snake[i].x, snake[i].y);
    ...
    /////////////////////////////////////////////////////////////
     ...
     /////////////////////////////////////////////////////////////
    var setPoison = function(poison_value){
        poison = poison_value;
        if(poison == 1){screen_snake.style.display = "block";}
        if(poison == 0){screen_snake.color = "black";}
    }
